    ...
    <div className="relative animate-slide-up stagger-3">
      ...
      <div className="relative glass rounded-2xl border border-zinc-800/50 overflow-hidden">
        ...
        <div className="p-6 border-b border-zinc-800/50">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              <div className="p-2.5 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 animate-float" style={{ animationDuration: '4.5s' }}>
              ...
              <div>
                ...
                <p className="text-sm text-zinc-500">Performance across all semesters</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <div className="px-3 py-1.5 rounded-lg bg-zinc-800/50 border border-zinc-700/50">
                <span className="text-xs text-zinc-500">Avg SGPA: </span>
              ...
              <div className="px-3 py-1.5 rounded-lg bg-zinc-800/50 border border-zinc-700/50">
                ...
                <span className="text-sm font-bold text-white">{totalCredits}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${getPerformanceColor(sem.sgpa)} flex items-center justify-center text-white font-bold text-sm shadow-lg`}>
                        {sem.euno}
                      </div>
                      <span className="text-sm font-semibold text-white">Semester {sem.euno}</span>
                    </div>
                    {getTrendIcon(index)}
                  </div>
                  
                  {/* SGPA highlight */}
                  <div className="mb-4 p-3 rounded-lg bg-gradient-to-r from-purple-500/10 to-violet-500/5 border border-purple-500/20">
                    <p className="text-xs text-zinc-500 mb-1">SGPA</p>
                    <p className={`text-2xl font-bold bg-gradient-to-r ${getPerformanceColor(sem.sgpa)} bg-clip-text text-transparent`}>
                      {sem.sgpa.toFixed(2)}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="p-2 rounded-lg bg-zinc-800/50">
                      <p className="text-[10px] text-zinc-500 uppercase tracking-wider">Marks</p>
          ...
          {/* Total summary bar */}
          <div className="mt-6 p-4 rounded-xl bg-gradient-to-r from-purple-500/10 via-violet-500/5 to-purple-500/10 border border-purple-500/20">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-zinc-500 uppercase tracking-wider">Total Summary</p>
                  <p className="text-white font-semibold">{semesters.length} Semesters Completed</p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div className="text-center">
                  <p className="text-xs text-zinc-500">Average SGPA</p>
                  <p className="text-xl font-bold text-purple-400">{avgSgpa.toFixed(2)}</p>
                </div>
              </div>
            </div>
          </div>
